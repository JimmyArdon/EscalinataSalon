...
const BorrarServicio = () => {
  ...
  const handleDelete = () => {
    if (servicio.id) {
      axios.delete(`https://66972cf402f3150fb66cd356.mockapi.io/api/v1/servicios/${servicio.id}`)
        .then(() => {
    ...
    <Container>
      ...
      {servicio.nombre && (
        <div className="bg-slate-500 p-10 rounded-[15px] w-full max-w-md text-center">
          <h3>¿Estás seguro de que deseas eliminar el servicio "{servicio.nombre}"?</h3>
